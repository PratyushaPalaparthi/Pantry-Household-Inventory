...
async def trigger_reindex(
    ...
    """Trigger a full reindex of local media uploads."""
    from app.workers.tasks import reindex_local_media
    ...
    # Queue the task
    reindex_local_media.delay(str(job.id), str(user_id) if user_id else None)
