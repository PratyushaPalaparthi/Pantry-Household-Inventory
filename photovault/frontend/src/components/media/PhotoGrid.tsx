    ...
    <div className={gridClass}>
      {media.map((item) => (
        ...
        >
          {/* Thumbnail */}
          <img
            src={mediaApi.getThumbnailUrl(item.id, 'large')}
            alt={item.filename}
          ...
          <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/70 via-black/35 to-transparent p-3 opacity-0 group-hover:opacity-100 transition-opacity">
