...
git clone https://github.com/suryaprakashreddyadapa/photo-webapp.git
cd photo-webapp
...
| `NAS_PATH` | Path to NAS mount | `./data/nas` |
| `ADMIN_EMAIL` | Initial admin email | `admin@photovault.app` |
| `ADMIN_PASSWORD` | Initial admin password | `admin123` |
| `EMAIL_VERIFICATION_REQUIRED` | Require email verification on login | `true` |
| `SMTP_HOST` | SMTP host (default: Mailpit in docker-compose) | `mailpit` |
